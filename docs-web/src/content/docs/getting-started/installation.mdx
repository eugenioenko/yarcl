...
<Aside type="caution">
yarcl is a prototype and isn't published to npm yet. In this repository it's consumed as a workspace package (`"yarcl": "workspace:*"`). The steps below are the same either way.
</Aside>
   ...
   ```jsonc title="tsconfig.json"
   {
     "compilerOptions": {
       ...
       "paths": {
         "@yarcl/config": [
           "./src/yarcl.config.ts",
           "./node_modules/yarcl/src/yarcl.default.config.ts"
         ]
       }
     }
   }
