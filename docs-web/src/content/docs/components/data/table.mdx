...
```tsx
<Table density="compact" radius="md" striped interactive caption="Invoices">
  <Table.Head>
    <Table.Row>
...
- `radius` accepts the keys of your [radii](/configuration/sizes-and-radii/#radii) group and styles the table frame.
